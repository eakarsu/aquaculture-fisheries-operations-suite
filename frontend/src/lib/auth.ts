export const AUTH_COOKIE = 'aquaculture_fisheries_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@aquaculture-fisheries-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@aquaculture-fisheries-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@aquaculture-fisheries-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
