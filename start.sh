...
PORT="${PORT:-5670}"
DB_NAME="${PGDATABASE:-aquaculture_fisheries_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Aquaculture Fisheries Operations Suite"
echo "======================================="
echo
...
echo "Starting aquaculture fisheries operations suite frontend on http://localhost:$PORT"
echo "Login: admin@aquaculture-fisheries-operations.local / admin123"
