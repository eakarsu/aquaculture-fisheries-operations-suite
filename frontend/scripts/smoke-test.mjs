const baseUrl = process.env.SMOKE_BASE_URL || 'http://127.0.0.1:5670';
...
const adminCookie = await login('admin@aquaculture-fisheries-operations.local', 'admin123');
const managerCookie = await login('manager@aquaculture-fisheries-operations.local', 'manager123');
const analystCookie = await login('analyst@aquaculture-fisheries-operations.local', 'analyst123');
